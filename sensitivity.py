...
def run_sensitivity(instance, base_params):
    ...
    with open(csv_path, 'w', newline='') as f:
        ...
        for row in rows:
            writer.writerow([
                ...
                row['fixed_cost'],
                row['objective_value'],
                row['num_selected_duties'],
                row['num_covered_trips'],
                row['solver_status'],
    ...
    _plot_metric(
        ...
        'max_duration',
        'objective_value',
        'Vrednost cilja (objective)',
        'Objective prema max_duration',
    ...
    _plot_metric(
        ...
        'max_duration',
        'num_selected_duties',
        'Broj izabranih duznosti',
        'Broj izabranih duznosti prema max_duration',
    ...
    _plot_metric(
        ...
        'num_selected_duties',
        'Broj izabranih duznosti',
        'Broj izabranih duznosti prema min_transfer',
    ...
    _plot_metric(
        ...
        'num_selected_duties',
        'Broj izabranih duznosti',
        'Broj izabranih duznosti prema fixed_cost',
...
if __name__ == '__main__':
    ...
    run_sensitivity(inst, {'max_duty_duration':8*60, 'min_transfer':15, 'fixed_cost':50.0, 'alpha':0.5})
